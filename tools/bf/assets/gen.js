/* ═══════════════════════════════════════════════════════════════════════════
   tools/bf/assets/gen.js — 本批 5 张 Lovart 素材 → art/** 切片（零依赖，纯 Node + zlib）
   ...
   与上一轮 tools/bf/icons/gen.js 同源的三条纪律：
   ...
   用法：node tools/bf/assets/gen.js [--keep-bg]
   ═══════════════════════════════════════════════════════════════════════════ */
"use strict";
...
const report = {
  ...
  note: "本批 Lovart 素材的全部切片参数（脚本 tools/bf/assets/gen.js 自动求出，未写死）",
  view: VIEW,
  background: bg,
  stars: stars,
  groups: groups,
