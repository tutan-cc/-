/* tools/mjsys/probe-lib.js — 麻将浏览器实测的公共底座（供 tools/e2e/mj-system.js / tools/mj/shots.js 复用）
...
/* 本文件在 tools/mjsys/ 下，故仓库根要退两级。
   注意 OUT 同时承担两个用途，二者都在仓库根：
     · 出图脚本用它拼 测试截图/ 与 tests/ 的路径
     · 探针用它落临时文件（_mj_panels.json / _mj_panels.hta / _mj_panels_out.txt）
   之所以不放 tools/：仓库根是 HTTP 服务根，生成物放这里既能被页面取到，也不会污染 tools/。 */
